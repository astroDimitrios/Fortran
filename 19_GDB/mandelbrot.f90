...
program mandelbrot
    ...
    character(str_def), parameter :: file_path = './mandelbrot/config_mandelbrot.nml'
    character(str_def)            :: output_file_path, size_str
    ...
    namelist /mandelbrot_conf/ size, iterations, threshold, smooth, xmin, xmax, ymin, ymax
    ...
    !$omp             shared(size, members, iterations, threshold,  &
